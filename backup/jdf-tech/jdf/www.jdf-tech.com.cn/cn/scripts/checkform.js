...
function checkString(obj)
{
 ...
 {
  tempArr[0]=false;
  tempArr[1]=""+ obj.checkStr+"不能小于"+smallLength+"位,请重新填写";
  return tempArr;
 }
 if(length > bigLength)
 {
  tempArr[0]=false;
  tempArr[1]=""+obj.checkStr+"不能大于"+bigLength+"位,请重新填写";
  return tempArr;
 }
 return tempArr;
}
...
function checkFloat(obj)
{
 ...
 {
  tempArr[0]=false;
  tempArr[1]="Not less than "+smallFloat+",Please write your " + obj.checkStr+" again!";
  return tempArr;
 }
 if(floatvalue > bigFloat)
 {
  tempArr[0]=false;
  tempArr[1]="Not greater than "+bigFloat+",Please write your " + obj.checkStr+" again!";
  return tempArr;
 }
 return tempArr;
}
...
function checkInteger(obj)
{
 ...
 {
  tempArr[0]=false;
  tempArr[1]="Not integer,Please input " + obj.checkStr+" again!";
  return tempArr;
 }
 ...
 {
  tempArr[0]=false;
  tempArr[1]="Not less than "+smallInteger+",Please input " + obj.checkStr+" again!";
  return tempArr;
 }
 if(integervalue > bigInteger)
 {
  tempArr[0]=false;
  tempArr[1]="Not greater than "+bigInteger+",Please input " + obj.checkStr+" again!";
  return tempArr;
 }
 return tempArr;
}
...
function checkNumber(obj)
{
 ...
 {
  tempArr[0]=false;
  tempArr[1]="Not numbers,Please input " + obj.checkStr+" again!";
  return tempArr;
 }
 ...
 {
  tempArr[0]=false;
  tempArr[1]="Not less than "+smallInteger+" units,Please input " + obj.checkStr+" again!";
  return tempArr;
 }
 if(integervalue > bigInteger)
 {
  tempArr[0]=false;
  tempArr[1]="Not greater than "+bigInteger+" units,Please input " + obj.checkStr+" again!";
  return tempArr;
 }
 return tempArr;
}
...
function checkalliframe()
{
	
}
function checkiForm(docname,formName)
{
 try
   {
   	
 var aa =eval(docname+".document.forms('"+formName+"').elements");
 var obj = null;
 var jumpFromFor = false;
 for (i=0;i<aa.length;i++)
 {
  ...
  if(aa[i].checkStr!=""&&aa[i].checkStr!=null)
  {
   ...
   if(obj.value.length==0)
   {
    if(obj.canEmpty!="Y")
    {
     alert("Please input "+obj.checkStr+"!");
     break;
    }
   }
   ...
   if(obj.equal!=null && obj.equal.length>0)
   {
    ...
    if(obj2 != null)
    {
     if(obj.value != obj2.value)
     {
      alert("With the "+obj.checkStr+" of the same "+obj2.checkStr+"!")
      break;
     }
    }
   }
   ...
   if(obj.checkType=="email")
   {
    if(!checkEmail(obj))
    {
     alert("" + obj.checkStr+" format is not correct!");
     break;
    }
   }
