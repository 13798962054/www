...
$cfg_basehost = 'http://www.virion-serion.net';
$cfg_cmspath = '';
$cfg_cookie_encode = 'CgTCx1688x';
$cfg_indexurl = '/';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright &copy; 2016-2020 维润赛润               备案号：粤ICP备16001200号-1';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '维润赛润  维润  赛润   生物技术   检测';
$cfg_description = '维润赛润生物技术（深圳）有限公司是德国维润赛润技术有限公司在中国设立的唯一合资子公司，是中国境内唯一具有签订维润赛润产品销售和服务授权协议的公司，公司于2016年1月1日正式运营，全面负责中国境内所有经销渠道的管理、产品销售、产品生产、技术服务和产品咨询。';
