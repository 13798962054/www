        ...
        <div class="row">
            <div class="col-lg-8 ml-auto mr-auto">
                <div class="history-area-content text-center">
                    <p><strong>深圳中南医学检验实验室是一家第三方独立医学实验室。</strong></p>
                    <p>重点发展基因检测、基础免疫检验和病理诊断。拥有三大技术平台：基因检测技术平台、免疫技术平台和病理诊断平台。四个研究发展方向和一个基地：脑脊液诊断、疫苗免疫效果评价、阿尔兹海默症研究诊断、奥科基因检测和维润赛润亚太培训基地。公司组建了一支包含国内外著名专家、教授和博士等高级科技人员的高层次和高素质的团队。</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="ht-single-about">
                                <div class="skill-bar">
                                    <div class="skill-bar-item">
                                        <span>无理由退换货</span>
                                        <div class="progress">
                                            <div class="progress-bar" data-progress="100%" style="width: 100%;">
