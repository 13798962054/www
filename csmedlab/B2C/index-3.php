...
<body>
	...
	<div class="wrapper">
		...
		<div class="slider-area">
		    <div class="hero-slider hero-slider-3 owl-carousel">
		        <!--Single Slider Start-->
		        <div class="single-slider slider-style-3" style="background-image: url(img/slider/home3-slider1.jpg)">   
                    <div class="slider-progress"></div>
		            <div class="container">
		                <div class="hero-slider-content hero-slider-content-3">
		        ...
		        <!--Single Slider End-->
		        <!--Single Slider Start-->
		        <div class="single-slider slider-style-3" style="background-image: url(img/slider/home3-slider2.jpg)">   
                    <div class="slider-progress"></div>
		            <div class="container">
		                <div class="hero-slider-content hero-slider-content-3">
                            <img class="slider3-text" src="img/slider/home3-slider2-text.png" alt="">
		                    <div class="slider-btn">
		                        <a href="#">Shop Collection <i class="fa fa-chevron-right"></i></a>
		                    </div>
		                </div>
		...
		<!--Feature History Area End-->
		<!--Shop Collections Area Start-->
		<div class="shop-collection-area gray-bg pt-120 pb-25">
		    <div class="container">
		        <div class="row">
		            <div class="col-md-6 col-left">
		                ...
		                <div class="single-collection mb-35">
		                    <div class="collection-img text-right mb-50">
		                        <img src="img/collections/collections1.jpg" alt="">
		                    </div>
		                    <div class="collection-content">
		                        <h3>Captain America 1</h3>
		                        <h4>Category: <a href="#">Potted Plant</a></h4>
		                        <p>Curabitur aliquet quam id dui posuere blandit. Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Mauris blandit aliquet elit,</p>
		                        <h2>$21.00</h2>
		                        <a class="collection-btn" href="#">Shop Collections</a>
		                    </div>
		                </div>
		            ...
		            <div class="col-md-6 col-right">
		                ...
		                <div class="single-collection mb-35">
		                    ...
		                    <div class="collection-img text-left">
		                        <img src="img/collections/collections2.jpg" alt="">
		                    </div>
		                </div>
		                <!--Single Collection End-->
		            </div>
		            ...
		            <div class="product-list-slider-active">
		                <div class="col-md-4">
                            ...
                            <div class="single-product product-list mb-35">
                                    <div class="list-col-4">
                                        <div class="product-img img-full">
                                            <a href="single-product.html"><img src="img/product/product14.jpg" alt=""></a>
                                            <span class="onsale">Sale!</span>
                                            <div class="product-action">
                                                <ul>
                            ...
                            <div class="single-product product-list mb-35">
                                    <div class="list-col-4">
                                        <div class="product-img img-full">
                                            <a href="single-product.html"><img src="img/product/product16.jpg" alt=""></a>
                                            <div class="product-action">
                                                <ul>
                                                    <li><a href="#open-modal" data-toggle="modal" title="Quick view" tabindex="0"><i class="fa fa-search"></i></a></li>
                                                    <li><a href="#" tabindex="0"><i class="fa fa-heart-o"></i></a></li>
		                ...
		                <div class="col-md-4">
                            ...
                            <div class="single-product product-list mb-35">
                                    <div class="list-col-4">
                                        <div class="product-img img-full">
                                            <a href="single-product.html"><img src="img/product/product15.jpg" alt=""></a>
                                            <span class="onsale">Sale!</span>
                                            <div class="product-action">
                                                <ul>
                                                    <li><a href="#open-modal" data-toggle="modal" title="Quick view" tabindex="0"><i class="fa fa-search"></i></a></li>
		                ...
		                <div class="col-md-4">
                            ...
                            <div class="single-product product-list mb-35">
                                    <div class="list-col-4">
                                        <div class="product-img img-full">
                                            <a href="single-product.html"><img src="img/product/product22.jpg" alt=""></a>
                                            <span class="onsale">Sale!</span>
                                            <div class="product-action">
                                                <ul>
                                                    <li><a href="#open-modal" data-toggle="modal" title="Quick view" tabindex="0"><i class="fa fa-search"></i></a></li>
		                ...
		                <div class="col-md-4">
                            ...
                            <div class="single-product product-list mb-35">
                                    <div class="list-col-4">
                                        <div class="product-img img-full">
                                            <a href="single-product.html"><img src="img/product/product23.jpg" alt=""></a>
                                            <div class="product-action">
                                                <ul>
                                                    <li><a href="#open-modal" data-toggle="modal" title="Quick view" tabindex="0"><i class="fa fa-search"></i></a></li>
                                                    <li><a href="#" tabindex="0"><i class="fa fa-heart-o"></i></a></li>
                            ...
                            <div class="single-product product-list mb-35">
                                    <div class="list-col-4">
                                        <div class="product-img img-full">
                                            <a href="single-product.html"><img src="img/product/product20.jpg" alt=""></a>
                                            <div class="product-action">
                                                <ul>
                                                    <li><a href="#open-modal" data-toggle="modal" title="Quick view" tabindex="0"><i class="fa fa-search"></i></a></li>
                                                    <li><a href="#" tabindex="0"><i class="fa fa-heart-o"></i></a></li>
                                    ...
                                    <div class="list-col-8">
                                        <div class="product-content">
                                            <h2><a href="single-product.html">Ornare sed consequat</a></h2>
                                            <div class="product-price">
                                                <div class="price-box">
		                ...
		                <div class="col-md-4">
                            ...
                            <div class="single-product product-list mb-35">
                                    <div class="list-col-4">
                                        <div class="product-img img-full">
                                            <a href="single-product.html"><img src="img/product/product19.jpg" alt=""></a>
                                            <span class="onsale">Sale!</span>
                                            <div class="product-action">
                                                <ul>
                                                    <li><a href="#open-modal" data-toggle="modal" title="Quick view" tabindex="0"><i class="fa fa-search"></i></a></li>
                            ...
                            <div class="single-product product-list mb-35">
                                    <div class="list-col-4">
                                        <div class="product-img img-full">
                                            <a href="single-product.html"><img src="img/product/product18.jpg" alt=""></a>
                                            <span class="onsale">Sale!</span>
                                            <div class="product-action">
                                                <ul>
                                                    <li><a href="#open-modal" data-toggle="modal" title="Quick view" tabindex="0"><i class="fa fa-search"></i></a></li>
		                ...
		                <div class="col-md-4">
                            ...
                            <div class="single-product product-list mb-35">
                                    <div class="list-col-4">
                                        <div class="product-img img-full">
                                            <a href="single-product.html"><img src="img/product/product17.jpg" alt=""></a>
                                            <div class="product-action">
                                                <ul>
                                                    <li><a href="#open-modal" data-toggle="modal" title="Quick view" tabindex="0"><i class="fa fa-search"></i></a></li>
                                                    <li><a href="#" tabindex="0"><i class="fa fa-heart-o"></i></a></li>
                            ...
                            <div class="single-product product-list mb-35">
                                    <div class="list-col-4">
                                        <div class="product-img img-full">
                                            <a href="single-product.html"><img src="img/product/product11.jpg" alt=""></a>
                                            <span class="onsale">Sale!</span>
                                            <div class="product-action">
                                                <ul>
                                                    <li><a href="#open-modal" data-toggle="modal" title="Quick view" tabindex="0"><i class="fa fa-search"></i></a></li>
		...
		<!--Bestseller List Product Area End-->
		<!--Testimonial Blog Area Start-->
		<div class="testimonial-blog-area gray-bg pt-115 pb-110 mt-105">
		    <div class="container">
		        <div class="row">
                            ...
                            <div class="row">
                                <div class="blog-list-slider-active">
                                    <div class="col-12">
                                        <!--Single List Blog-->
                                        <div class="blog-list">
                                            <div class="post-date">07/09/2017</div>
                                            <h3 class="post-title"><a href="single-blog.html" tabindex="0">Blog image post</a></h3>
                                            <p class="post-author">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="blog-list">
                                            <div class="post-date">07/09/2017</div>
                                            <h3 class="post-title"><a href="single-blog.html" tabindex="0">Post with Gallery</a></h3>
                                            <p class="post-author">
                                               <img src="img/icon/author.png" alt=""> <span>Posted by </span>
                                               <a href="#" tabindex="0">admin </a>
                                            </p>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="blog-list">
                                            <div class="post-date">07/09/2017</div>
                                            <h3 class="post-title"><a href="single-blog.html" tabindex="0">Post with Audio</a></h3>
                                            <p class="post-author">
                                               <img src="img/icon/author.png" alt=""> <span>Posted by </span>
                                               <a href="#" tabindex="0">admin </a>
                                            </p>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="blog-list">
                                            <div class="post-date">07/09/2017</div>
                                            <h3 class="post-title"><a href="single-blog.html" tabindex="0">Post with Video</a></h3>
                                            <p class="post-author">
                                               <img src="img/icon/author.png" alt=""> <span>Posted by </span>
                                               <a href="#" tabindex="0">admin </a>
                                            </p>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="blog-list">
                                            <div class="post-date">07/09/2017</div>
                                            <h3 class="post-title"><a href="single-blog.html" tabindex="0">Maecenas ultricies</a></h3>
                                            <p class="post-author">
                                               <img src="img/icon/author.png" alt=""> <span>Posted by </span>
                                               <a href="#" tabindex="0">admin </a>
                                            </p>
		...
		<div class="news-letter-area mt-85 mb-120">
		    <div class="container">
		        <div class="row">
		            <!--Section Title Start-->
		            <div class="col-12">
		                ...
		                <div class="row">
		                    <div class="col-md-12">
		                        ...
		                        <div class="footer-copyright">
		                            <p>Copyright © <a href="#">Plantmore</a> All Rights Reserved</p>
		                        </div>
