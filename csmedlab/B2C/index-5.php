                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="hero-slider hero-slider-5 owl-carousel">
                            <!--Single Slider Start-->
                            <div class="single-slider-style-5" style="background-image: url(img/slider/home5-slider1.jpg)">   
                                <div class="slider-progress"></div>
                                <div class="hero-slider-content hero-slider-content-5">
                                    <img class="first-img" src="img/slider/home5-slider1-text1.png" alt="">
                                    <img class="secound-img" src="img/slider/home5-slider1-icon.png" alt="">
                                </div>
                            </div>
                            <!--Single Slider End-->
                            <!--Single Slider Start-->
                            <div class="single-slider-style-5" style="background-image: url(img/slider/home5-slider2.jpg)">   
                                <div class="slider-progress"></div>
                                <div class="hero-slider-content hero-slider-content-6">
                                   <img class="first-img" src="img/slider/home5-slider2-text.png" alt="">
                                   <img class="secound-img" src="img/slider/home5-slider2-icon.png" alt="">
                                </div>
                            </div>
                            <!--Single Slider End-->
                        </div>
                                ...
                                <div class="sidebar-product-active">
                                    <div class="product-item">
                                        ...
                                        <div class="single-product product-list">
                                            ...
                                            <div class="list-col-8">
                                                <div class="product-content">
                                                    <h2><a href="single-product.html">Phasellus vel hss</a></h2>
                                                    <div class="product-price">
                                                        <div class="price-box">
                                        ...
                                        <div class="single-product product-list">
                                            ...
                                            <div class="list-col-8">
                                                <div class="product-content">
                                                    <h2><a href="single-product.html">Pellentesque furniture</a></h2>
                                                    <div class="product-price">
                                                        <div class="price-box">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="single-product product-list">
                                            ...
                                            <div class="list-col-8">
                                                <div class="product-content">
                                                    <h2><a href="single-product.html">Kaoreet furniture</a></h2>
                                                    <div class="product-price">
                                                        <div class="price-box">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="single-product product-list">
                                            ...
                                            <div class="list-col-8">
                                                <div class="product-content">
                                                    <h2><a href="single-product.html">Habitasse dictumst</a></h2>
                                                    <div class="product-price">
                                                        <div class="price-box">
                                                            <span class="regular-price">$60.00</span>
                                                        </div>
