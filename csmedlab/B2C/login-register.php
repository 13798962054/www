		                    ...
		                    <div class="login-form">
		                        <form action="#">
		                            ...
		                            <div class="login-submit">
		                                <button type="submit" class="form-button">登陆</button>
		                                <label>
		            ...
		            <div class="col-md-6 col-sm-6">
		                <div class="customer-login-register register-pt-0">
		                    ...
		                    <div class="register-form">
		                        <form action="#">
		                            <div class="form-fild">
		                                <p><label>手机号或者邮箱<span class="required">*</span></label></p>
		                                <input name="username" type="text">
		                            </div>
                                    ...
                                    <div class="form-fild">
                                        <p><label>确认密码<span class="required">*</span></label></p>
                                        <input name="password" value="" type="password">
                                    </div>
