		                                    ...
		                                    <div class="row">
		                                        ...
		                                        <div class="col-md-4">
                                                    ...
                                                    <div class="single-product mb-25">
                                                        ...
                                                        <div class="product-content">
                                                            <h2><a href="single-product.php">Aliquam sit amet</a></h2>
                                                            <div class="product-price">
                                                                <div class="price-box">
		                                        ...
		                                        <div class="col-md-4">
                                                    ...
                                                    <div class="single-product mb-25">
                                                        ...
                                                        <div class="product-content">
                                                            <h2><a href="single-product.php">Aliquet auctor sem</a></h2>
                                                            <div class="product-price">
                                                                <div class="price-box">
		                                        ...
		                                        <div class="col-md-4">
                                                    ...
                                                    <div class="single-product mb-25">
                                                        ...
                                                        <div class="product-content">
                                                            <h2><a href="single-product.php">Condimentum posuere</a></h2>
                                                            <div class="product-price">
                                                                <div class="price-box">
		                                        ...
		                                        <div class="col-md-4">
                                                    ...
                                                    <div class="single-product mb-25">
                                                        ...
                                                        <div class="product-content">
                                                            <h2><a href="single-product.php">Convallis furniture</a></h2>
                                                            <div class="product-price">
                                                                <div class="price-box">
		                                        ...
		                                        <div class="col-md-4">
                                                    ...
                                                    <div class="single-product mb-25">
                                                        ...
                                                        <div class="product-content">
                                                            <h2><a href="single-product.php">Curabitur a purus</a></h2>
                                                            <div class="product-price">
                                                                <div class="price-box">
		                                        ...
		                                        <div class="col-md-4">
                                                    ...
                                                    <div class="single-product mb-25">
                                                        ...
                                                        <div class="product-content">
                                                            <h2><a href="single-product.php">Diam vel neque</a></h2>
                                                            <div class="product-price">
                                                                <div class="price-box">
		                                        ...
		                                        <div class="col-md-4">
                                                    ...
                                                    <div class="single-product mb-25">
                                                        ...
                                                        <div class="product-content">
                                                            <h2><a href="single-product.php">Convallis quam sit</a></h2>
                                                            <div class="product-price">
                                                                <div class="price-box">
		                                ...
		                                <div class="product-list-view">
		                                        ...
		                                        <div class="row">
		                                            ...
		                                            <div class="col-md-8">
		                                                <div class="product-content shop-list">
		                                                    <h2><a href="single-product.php">Aliquam furniture</a></h2>
		                                    ...
		                                    <div class="product-list-item mb-40">
		                                        <div class="row">
		                                            ...
		                                            <div class="col-md-8">
		                                                <div class="product-content shop-list">
		                                                    <h2><a href="single-product.php">Condimentum furniture</a></h2>
		                                                    <div class="product-reviews">
                                                                <i class="fa fa-star"></i>
                                                                <i class="fa fa-star"></i>
                                                                <i class="fa fa-star"></i>
