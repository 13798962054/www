...
function gene_detection_1(){
    self.location="gene_detection_1.html"
}
//乳腺癌基因检测
function gene_detection_2(){
    self.location="gene_detection_2.html"
}
//天赋基因检测
function gene_detection_3(){
    self.location="gene_detection_3.html"
}
//抑郁症基因检测
function gene_detection_4(){
    self.location="gene_detection_4.html"
}
//结肠癌基因检测
function gene_detection_5(){
    self.location="gene_detection_5.html"
}
//多肿瘤基因检测
function gene_detection_6(){
    self.location="gene_detection_6.html"
}
//全基因组检测
function gene_detection_7(){
    self.location="gene_detection_7.html"
}
