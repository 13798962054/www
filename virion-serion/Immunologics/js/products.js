        ...
        productsList1: [
            ...
            [
                ...
                [
                    ...
                    [""],
                    ["BA109VS", "巨细胞病毒抗原", "Cytomegalovirus (CMV) Antigen ", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 弓形虫（1）
                [
                    ["弓形虫（Toxoplasma gondii）是弓形虫病的病原体，可引发先天性弓形虫病导致自然流产、新生儿严重感染等。"],
                    [""],
                    ["BA110VS", "弓形虫抗原", "Toxoplasma gondii Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 风疹病毒（1）
                [
                    ["风疹病毒（Rubella Virus）是风疹的病原体，可引起淋巴结肿大和先天性疾病。"],
                    [""],
                    ["BA129G2VS", "风疹病毒抗原", "Rubella Virus Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 单纯疱疹病毒（1型）（2）
                [
                    ...
                    ["BA1051VS", "单纯疱疹病毒（1型）抗原", "HSV-1 Antigen ", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"],
                ...
                [
                    ...
                    [""],
                    ["BA1052VS", "单纯疱疹病毒（2型）抗原", "HSV-2 Antigen ", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"],
                ...
                [
                    ...
                    [""],
                    [" BA127VS", "肺炎支原体抗原", "Mycoplasma pneumoniae Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"],
                ...
                [
                    ...
                    [""],
                    ["BA1371VS", "肺炎衣原体抗原（优级）", "Chlamydia pneumoniae Antigen (Premium) ", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"],
                    ["BA1371VSER", "肺炎衣原体抗原", "Chlamydia pneumoniae Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 呼吸道合胞病毒（1）
                [
                    ["呼吸道合胞病毒（Respiratory Syncytial Virus）是小儿病毒性肺炎的常见病原体，可引起间质性肺炎和毛细支气管炎。"],
                    [""],
                    [" BA113VS", "呼吸道合胞病毒抗原", "Respiratory Syncytial Virus (RSV) Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 人腺病毒（1）
                [
                    ...
                    [""],
                    ["BA128VS", "腺病毒2型六联体蛋白", "Adenovirus Type 2 Hexon", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 副流感病毒（3）
                [
                    ["副流感病毒（Parainfluenza Virus）是副流行性感冒的病原体，可引起哮、呼吸困难等症状。"],
                    [""],
                    ["BA1261VS", "副流感病毒（1型）抗原", "Parainfluenza Virus Type 1 Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"],
                    ["BA1262VS ", "副流感病毒（2型）抗原", "Parainfluenza Virus Type 2 Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"],
                    ["BA1263VS ", "副流感病毒（3型）抗原", "Parainfluenza Virus Type 3 Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 寨卡病毒
                [
                    ["寨卡（Zika）病毒病是由寨卡病毒引起的一种自限性急性传染病，主要通过埃及伊蚊叮咬传播。世界卫生组织（ WHO ）认为，新生儿小头畸形、格林 巴利综合征（吉兰 巴雷综合征）可能与寨卡病毒感染有关。"],
                    [],
                    ["BA149R01", "寨卡病毒NS1蛋白", "Zika Virus NS1", "德国virion\\serion", "重组蛋白", "包被；标记", "≤-65℃，10年", "1mg；5mg；10mg"]
                ],
                // 嗜肺军团菌（1）
                [
                    ["嗜肺军团菌（Legionella pneumophila）是军团菌肺炎的病原体，可引起高热、呼吸困难、水泻等。"],
                    [""],
                    ["BA106VS", "嗜肺军团菌抗原", "Legionella pneumophila Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 百日咳杆菌（3）
                [
                    ...
                    [""],
                    ["BA120VS3", "百日咳杆菌丝状血凝素", "Bordetella pertussis Filamentous Hemagglutinin (FHA) ", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"],
                    ["BA120VS4", "百日咳毒素", "Bordetella pertussis Toxin（PT）", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"],
                    ["BA120VS8", "百日咳全细胞抗原", "Bordetella pertussis whole-cell Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 腮腺炎病毒（1）
                [
                    [" 腮腺炎病毒（Mumps Virus）是流行性腮腺炎的病原体，可引起发热、生殖系统并发症和神经系统并发症等。"],
                    [""],
                    ["BA103VS", "腮腺炎病毒抗原", "Mumps Virus Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 柯萨奇病毒（1）
                [
                ...
                [
                    ...
                    ["BA122VSVP2", "细小病毒B19 VP2病毒样颗粒（aa 228-781）", "Parvovirus VP2 VLP", "德国virion\\serion", "重组蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // EB病毒（5）
                [
                ...
                [
                    ...
                    [""],
                    ["BA117VS", "白色念珠菌抗原", "Candida albicans", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 幽门螺旋杆菌（1）
                [
                    ["幽门螺旋杆菌（Helicobacter pylori）是慢性胃病的病原体之一，可引起慢性胃炎和溃疡病等。"],
                    [""],
                    ["BA118VS", "幽门螺旋杆菌抗原", "Helicobacter pylori Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 麻疹病毒（2）
                [
                    ["麻疹病毒（Measles Virus）是麻疹的病原体，可引起发热、肺炎、脑炎等症状，是儿童最常见的急性传染病。"],
                    [""],
                    [" BA102VS-S", "麻疹病毒抗原（优级）", "Measles Virus Antigen - Premium", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"],
                    ["BA102VS", "麻疹病毒抗原", "Measles Virus Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 轮状病毒（1）
                [
                    ["轮状病毒（Rotavirus Antigen）是引起婴儿腹泻的主要病原体之一，可造成细胞损伤和急性肠胃炎等。"],
                    [""],
                    ["BA1193VS", "轮状病毒抗原", "Rotavirus Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 水痘-带状疱疹病毒（2）
                [
                    ["水痘带状疱疹病毒（Varicella Zoster Virus ，VZV）是带状疱疹的病原体，引起急性炎症性皮肤病，可导致并发性肺炎、胎儿畸形和流产等。"],
                    [""],
                    ["BA104VS", "水痘-带状疱疹病毒抗原", "Varicella Zoster Virus (VZV) Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"],
                    ["BA104VSG", "水痘-带状疱疹病毒糖蛋白抗原", "Varicella Zoster Virus (VZV) Glycoprotein", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 流产嗜性衣原体（1）
                [
                    ["流产嗜性衣原体（Chlamydia abortus）是人兽共患病病原，可引起孕妇流产及全身感染等症状。"],
                    [""],
                    ["BA1373VSER", "流产嗜性衣原体抗原", "Chlamydia abortus Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 沙眼衣原体（2）
                [
                    ["沙眼衣原体（Chlamydia trachomatis）可引起沙眼、包涵体包膜炎和性病淋巴肉芽肿等疾病。"],
                    [""],
                    ["BA1372VSER", "沙眼衣原体抗原", "Chlamydia trachomatis Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"],
                ...
                [
                    ...
                    [""],
                    [" BA138VS", "耶尔森菌（O:3血清型）抗原", "Yersinia enterocolitica O:3 YOP Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"],
                    ["BA13808VS ", "耶尔森菌（O:8血清型）抗原", "Yersinia enterocolitica O:8 YOP Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"],
                    ["BA13809VS", "耶尔森菌（O:9血清型）抗原", "Yersinia enterocolitica O:9 YOP Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 空肠弯曲杆菌（1）
                [
                    ["空肠弯曲杆菌（Campylobacter jejuni）是空肠弯曲菌病的病原体，可引起腹痛、腹泻、头痛、发热等胃肠炎症状。"],
                    [""],
                    ["BA139VS", "空肠弯曲杆菌抗原", "Campylobacter jejuni Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 布鲁氏杆菌（1）
                [
                    ["布鲁氏杆菌（Brucella abortus）是布鲁氏菌病的病原体，可引起人畜共患的急、慢性传染病。"],
                    [""],
                    ["BA116VS", "布鲁氏杆菌抗原", "Brucella abortus Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 伯氏疏螺旋体（4）
                [
                    ...
                    [""],
                    ["BA121VS", "阿弗西尼疏螺旋体抗原", "Borrelia afzelii Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"],
                    ["BA121GVS", "伽氏疏螺旋体抗原", "Borrelia garinii Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"],
                ...
                [
                    ...
                    [""],
                    ["BA125VS", "双曲钩端螺旋体抗原", "Leptospira biflexa Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 细粒棘球绦虫（1）
                [
                    ["细粒棘球绦虫（Echinococcus granulosus）是囊型包虫病的病原体，可引起宿主体内压迫并发症、感染并发症和继发性门静脉高压症等。"],
                    [""],
                    ["BA107VS", "细粒棘球绦虫抗原", "Echinococcus granulosus Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 森林脑炎病毒（2）
                [
                    ["森林脑炎病毒（Tick-borne encephalitis Virus，TBEV）是森林脑炎（又名蜱传脑炎）的病原体，是经蜱传播，可引起以中枢神经系统病变为特征的急性传染病。"],
                    [""],
                    ["BA112VS ", "森林脑炎病毒抗原（优级）", "Tick-borne encephalitis (TBE) Virus Antigen - Premium", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"],
                    ["BA112VSL", "森林脑炎病毒抗原", "Tick-borne encephalitis (TBE) Virus Antigen", "德国virion\\serion", "天然蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ],
                // 基孔肯雅病毒（3）
                [
                    ...
                    ["BA148R1", "基孔肯雅病毒糖蛋白E2", "Chikungunya Glycoprotein E2", "德国virion\\serion", "重组蛋白", "包被；标记", "≤-65℃，10年", "1mg;5mg;10mg"]
                ]
            ],
            // 1 人源化单抗
            [
                ...
                [
                    ...
                    ["MAB109.001", "抗巨细胞病毒单抗", "Anti-Cytomegalovirus (CMV) IgM", "人源化单抗，IgM型", "可制备质控品、校准品和标准品；<br />作为免疫诊断的包被原/标记原。", "1mL，5mL，10mL，50mL"],
                    ["MAB109.002", "抗巨细胞病毒单抗", "Anti-Cytomegalovirus (CMV) IgM", "人源化单抗，IgM型", "可制备质控品、校准品和标准品；<br />作为免疫诊断的包被原/标记原。", "1mL，5mL，10mL，50mL"]
                ],
                // 抗弓形虫（1）
                [
                    ["弓形虫（Toxoplasma gondii）是弓形虫病的病原体，可引发先天性弓形虫病导致自然流产、新生儿严重感染等。"],
                    [""],
                    ["MAB110.001", "抗弓形虫单抗", "Anti-Toxoplasma gondii IgM", "人源化单抗，IgM", "可制备质控品、校准品和标准品；<br />作为免疫诊断的包被原/标记原。", "1mL，5mL，10mL，50mL"]
                ],
                // 抗单纯疱疹病毒（1）
                [
                    ["单纯疱疹病毒属于人类疱疹病毒，其中1型病毒可引起发热、脑炎、皮肤疱疹性湿疹，2型病毒属于人类疱疹病毒，可引起生殖器疱疹、生殖器外损伤和无菌性脑膜炎。"],
                    [""],
                    ["MAB105.001", "抗单纯疱疹病毒1+2型单抗", "Anti-Herpes Simplex Virus 1/2 (HSV-1/2) IgM", "人源化单抗，IgM", "可制备质控品、校准品和标准品；<br />作为免疫诊断的包被原/标记原。", "1mL，5mL，10mL，50mL"]
                ],
                // 抗水痘带状疱疹病毒（2）
                [
                    ["水痘带状疱疹病毒（Varicella Zoster Virus ，VZV）是带状疱疹的病原体，引起急性炎症性皮肤病，可导致并发性肺炎、胎儿畸形和流产等。"],
                    [""],
                    ["MAB104.001", "抗水痘带状疱疹病毒单抗", "Anti-Varicella Zoster Virus (VZV) IgM", "人源化单抗，IgM", "可制备质控品、校准品和标准品；<br />作为免疫诊断的包被原/标记原。", "1mL，5mL，10mL，50mL"],
                    ["MAB104.002", "抗水痘带状疱疹病毒单抗", "Anti-Varicella Zoster Virus (VZV) IgM", "人源化单抗，IgM", "可制备质控品、校准品和标准品；<br />作为免疫诊断的包被原/标记原。", "1mL，5mL，10mL，50mL"]
                ],
                // 抗风疹病毒（2）
                [
                    ["风疹病毒（Rubella Virus）是风疹的病原体，可引起淋巴结肿大和先天性疾病。"],
                    [""],
                    ["MAB129.001", "抗风疹病毒单抗", "Anti-Rubella Virus IgM", "人源化单抗，IgM", "可制备质控品、校准品和标准品；<br />作为免疫诊断的包被原/标记原。", "1mL，5mL，10mL，50mL"],
                    ["MAB129.002", "抗风疹病毒单抗", "Anti-Rubella Virus IgM", "人源化单抗，IgM", "可制备质控品、校准品和标准品；<br />作为免疫诊断的包被原/标记原。", "1mL，5mL，10mL，50mL"]
                ],
                // 抗麻疹病毒（1）
                [
                    ["麻疹病毒（Measles Virus）是麻疹的病原体，可引起发热、肺炎、脑炎等症状，是儿童最常见的急性传染病。"],
                    [""],
                    ["MAB102.001", "抗麻疹病毒单抗", "Anti-Measles Virus IgM", "人源化单抗，IgM", "可制备质控品、校准品和标准品；<br />作为免疫诊断的包被原/标记原。", "1mL，5mL，10mL，50mL"]
                ],
                // 抗腮腺炎病毒（2）
                [
                    ["腮腺炎病毒（Mumps Virus）是流行性腮腺炎的病原体，可引起发热、生殖系统并发症和神经系统并发症等。"],
                    [""],
                    ["MAB103.001", "抗流行性腮腺炎单抗", "Anti-Mumps Virus IgM", "人源化单抗，IgM", "可制备质控品、校准品和标准品；<br />作为免疫诊断的包被原/标记原。", "1mL，5mL，10mL，50mL"],
                    ["MAB103.002", "抗流行性腮腺炎单抗", "Anti-Mumps Virus IgM", "人源化单抗，IgM", "可制备质控品、校准品和标准品；<br />作为免疫诊断的包被原/标记原。", "1mL，5mL，10mL，50mL"]
                ],
                // 抗EB病毒（1）
                [
                    ["EB病毒（Epstein-Barr virus）属于人类疱疹病毒，可引起单核细胞增多、腺热等症状。"],
                    [""],
                    ["MAB1361.001", "抗EB病毒 VCA P18单抗", "Anti-Epstein-Barr Virus (EBV) VCA P18 IgM", "人源化单抗，IgM", "可制备质控品、校准品和标准品；<br />作为免疫诊断的包被原/标记原。", "1mL，5mL，10mL，50mL"]
                ],
                // 抗肺炎衣原体（1）
                [
                    ["肺炎衣原体（Chlamydia pneumoniae）是肺炎的病原体，主要引起呼吸道和肺部感染。"],
                    [""],
                    ["MAB1371.001", "抗肺炎衣原体单抗", "Anti-Chlamydia pneumoniae IgM", "人源化单抗，IgM", "可制备质控品、校准品和标准品；<br />作为免疫诊断的包被原/标记原。", "1mL，5mL，10mL，50mL"]
                ],
                // 抗肺炎支原体（1）
                [
                    ["肺炎支原体（Mycoplasma pneumoniae）是原发性非典型肺炎的病原体，可引起头痛、咳嗽等一般的呼吸道症状。"],
                    [""],
                    ["MAB127.001", "抗肺炎支原体单抗", "Anti-Mycoplasma pneumoniae IgM", "人源化单抗，IgM", "可制备质控品、校准品和标准品；<br />作为免疫诊断的包被原/标记原。", "1mL，5mL，10mL，50mL"]
                ],
                // 抗寨卡病毒（1）
                [
                    ["寨卡病毒（Zika virus）是一种通过蚊虫进行传播的虫媒病毒。人被感染后的常见征状包括发烧、关节疼痛、头痛和结膜炎等。"],
                    [""],
                    ["MAB149.001", "抗寨卡病毒单抗", "Anti-Zika Virus IgM", "人源化单抗，IgM", "可制备质控品、校准品和标准品；<br />作为免疫诊断的包被原/标记原。", "1mL，5mL，10mL，50mL"]
                ],
                // 抗登革热病毒（1）
                [
                    ["登革热是登革热病毒引起、依蚊传播的一种急性传染病。临床特征为起病急骤，高热，全身肌肉、骨髓及关节痛，极度疲乏，部分患可有皮疹、出血倾向和淋巴结肿大。"],
                    [""],
                    ["MAB114.001", "抗登革热单抗", "Anti-Dengue Virus IgM", "人源化单抗，IgM", "可制备质控品、校准品和标准品；<br />作为免疫诊断的包被原/标记原。", "1mL，5mL，10mL，50mL"]
                ]
            ],
            // 2原辅料
            [
