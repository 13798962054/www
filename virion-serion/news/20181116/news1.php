...
<div id="news">
    ...
    <h3>维润赛润深圳公司《中华检验医学杂志》广告</h3>
          <!-- JiaThis Button BEGIN -->
          <div class="clearfix" style=" margin-top:10px; margin-bottom:10px; text-align:right;"> </div>
          <!-- JiaThis Button END -->
          <p>　<div style="text-align: center;">
    <img alt="" src="/uploads/allimg/181116/1-1Q1161412334c.png" style="width: 669px; height: 950px;" /><br />
    &nbsp;</div>
<div>
    <span style="font-size:14px;"><strong>来源：中华检验医学杂志 2018年10月&nbsp; 第41卷&nbsp; 第10期</strong></span></div>
 </p>
</div>
