...
<div id="news">
    ...
    <h3>维润赛润生物技术（深圳）有限公司《中华检验医学杂志》广告（2019年2月）</h3>
          <!-- JiaThis Button BEGIN -->
          <div class="clearfix" style=" margin-top:10px; margin-bottom:10px; text-align:right;"> </div>
          <!-- JiaThis Button END -->
          <p>　<div style="text-align: center;">
    <img alt="" src="/uploads/allimg/190404/1-1Z404144434M4.jpg" style="width: 620px; height: 875px;" /></div>
<div style="text-align: center;">
    &nbsp;&nbsp;&nbsp;&nbsp; <span style="font-size:16px;">来源：中华检验医学杂志2019年2月第42卷第2期</span></div>
 </p>
</div>
