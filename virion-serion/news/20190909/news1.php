...
<div id="news">
    ...
    <h3>维润赛润深圳公司《中华检验医学杂志》广告（2019年8月）</h3>
          <!-- JiaThis Button BEGIN -->
          <div class="clearfix" style=" margin-top:10px; margin-bottom:10px; text-align:right;"> </div>
          <!-- JiaThis Button END -->
          <p>　<div class="clearfix" style=" margin-top:10px; margin-bottom:10px; text-align:right;">
    &nbsp;</div>
    <p>
    　</p>
    <div style="text-align: center;">
    <img alt="" src="http://www.virion-serion.net/uploads/allimg/190716/1-1ZG6162HO60.png" style="width: 623px; height: 895px;" /><br />
    <span style="font-size:16px;">来源：中华检验医学杂志：2019年8月&nbsp;&nbsp; 第42卷&nbsp; 第8期</span></div>
    </p>
</div>
