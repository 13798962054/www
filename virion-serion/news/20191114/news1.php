...
<div id="news">
    ...
    <h3>维润赛润深圳公司《中华检验医学杂志》广告（2019年10月）</h3>
          <!-- JiaThis Button BEGIN -->
          <div class="clearfix" style=" margin-top:10px; margin-bottom:10px; text-align:right;"> </div>
          <!-- JiaThis Button END -->
          <p>　<div style="text-align: center;">
    <img alt="" src="/uploads/allimg/191113/1-1911130U403406.png" style="width: 623px; height: 895px;" /><br />
    &nbsp;</div>
<div style="text-align: center;">
    <span style="color: rgb(102, 102, 102); font-family: 微软雅黑; font-size: 16px; text-align: center;">来源：中华检验医学杂志：2019年10月&nbsp;&nbsp; 第42卷&nbsp; 第10期</span></div>
 </p>
</div>
